...
class TestInterval:
    def test_should_ignore(self):
        sullivan_1 = Stop("29001", "Sullivan Station Busway - Berth 1", None)
        sullivan_2 = Stop("20002", "Sullivan Station Busway - Berth 2", None)
        fields_corner = Stop("323", "Fields Corner Busway", None)
        chelsea_inbound = Stop("74630", "Chelsea - Inbound", None)
        chelsea_outbound = Stop("74631", "Chelsea - Outbound", None)
